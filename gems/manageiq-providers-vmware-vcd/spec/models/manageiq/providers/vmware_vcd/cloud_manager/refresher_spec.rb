describe ManageIQ::Providers::VmwareVcd::CloudManager::Refresher do
  before(:each) do
  ...
  it ".ems_type" do
    expect(described_class.ems_type).to eq(:vmware_vcd)
  end
  ...
  def assert_specific_vm_powered_on
    v = ManageIQ::Providers::VmwareVcd::CloudManager::Vm.where(
      :name            => "login").first
